                ...
                <div class="card-body">
                    ...
                    @if($request->status === 'approved' || $request->status === 'rejected')
                        <div class="alert alert-success text-center">
                            <p><strong>Request Handled</strong></p>
                        </div>
                    @else
                        <form action="{{ route('requests.respond', $request->id) }}" method="POST">
                            ...
                            <div class="form-group mb-3" id="penalty-group">
                                <label for="penalty_type">Penalty</label>
                                <select class="form-select" name="penalty_type" id="penalty_type" required>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control" name="admin_remarks" rows="4"></textarea>
                            </div>
        ...
        <div class="col-md-5">
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <p><strong><i class="bi bi-building me-2"></i> Company:</strong> {{ $request->student->acceptedInternship->job->company->name ?? 'N/A' }}</p>
