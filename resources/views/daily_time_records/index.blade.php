    ...
    @else
            ...
            <div class="col-md-6">
                <div class="card mb-3" style="height: 150px;">
                    <div class="card-body">
                        ...
                        <p><strong>Total Hours:</strong> {{ $totalWorkedHours }} / {{ $internshipHours->hours }} hrs <strong>({{ round($completionPercentage, 2) }}%)</strong></p>
                        <div class="progress">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex justify-content-center">
                                    ...
                                    <form action="{{ route('dtr.logTime', ['type' => 'morning_in']) }}" method="POST" class="me-2">
                                        @csrf
                                        <button type="submit" class="btn btn-primary" {{ isset($logTimes['morning_in']) ? 'disabled' : '' }}>
                                            <i class="bi bi-arrow-right-circle me-1"></i> Morning In
                                        </button>
                                    </form>
                                    ...
                                    <form action="{{ route('dtr.logTime', ['type' => 'morning_out']) }}" method="POST">
                                        @csrf
                                        <button type="submit" class="btn btn-danger" {{ isset($logTimes['morning_out']) ? 'disabled' : '' }}>
                                            <i class="bi bi-arrow-left-circle me-1"></i> Morning Out
                                        </button>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex justify-content-center">
                                    ...
                                    <form action="{{ route('dtr.logTime', ['type' => 'afternoon_in']) }}" method="POST" class="me-2">
                                        @csrf
                                        <button type="submit" class="btn btn-primary" {{ isset($logTimes['afternoon_in']) ? 'disabled' : '' }}>
                                            <i class="bi bi-arrow-right-circle me-1"></i> Afternoon In
                                        </button>
                                    </form>
                                    ...
                                    <form action="{{ route('dtr.logTime', ['type' => 'afternoon_out']) }}" method="POST">
                                        @csrf
                                        <input type="hidden" name="test_time" value="09:00 AM"> 
                                        <button type="submit" class="btn btn-danger" {{ isset($logTimes['afternoon_out']) ? 'disabled' : '' }}>
                                            <i class="bi bi-arrow-left-circle me-1"></i> Afternoon Out
                                        </button>
                                    </form>
                                </div>
                            </div>
        ...
        <!-- <div class="row mb-2">
            <div class="col-md-6">
                <div class="card mb-3">
                    <div class="card-body">
                        <h5 class="card-title"><i class="bi bi-building me-2"></i>Company</h5>
                        <div class="table-responsive">
                            <p>{{ $acceptedInternship->job->company->name }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="card mb-3">
                    <div class="card-body">
                        <h5 class="card-title"><i class="bi bi-person-badge me-2"></i> Job Title</h5>
                        <p>{{ $acceptedInternship->job->title }}</p>
                    </div>
                </div>
            </div>
        </div> -->
            ...
            <div class="col-md-6">
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <p><strong><i class="bi bi-hourglass-split"></i> Internship Hours:</strong> {{ $internshipHours->hours }} hours</p>
