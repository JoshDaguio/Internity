                ...
                <div class="card mb-3" style="height: 330px;">
                    <div class="card-body">
                        <h5 class="card-title">Internship Progress</h5>
                            @if($remainingHours > 0)
                                <p><strong><i class="bi bi-hourglass-split"></i> Total Hours:</strong> {{ $totalWorkedHours }} / {{ $internshipHours->hours }} hrs <strong>({{ round($completionPercentage, 2) }}%)</strong></p>
                            @else
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex justify-content-center">
                                    ...
                                    <form action="{{ route('dtr.logTime', ['type' => 'morning_in']) }}" method="POST" class="me-2">
                                        @csrf
                                        <!-- <input type="hidden" name="test_time" value="07:01 AM"> -->
                                    ...
                                    <form action="{{ route('dtr.logTime', ['type' => 'morning_out']) }}" method="POST">
                                        @csrf
                                        <!-- <input type="hidden" name="test_time" value="11:03 AM"> -->
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex justify-content-center">
                                    ...
                                    <form action="{{ route('dtr.logTime', ['type' => 'afternoon_in']) }}" method="POST" class="me-2">
                                        @csrf
                                        <!-- <input type="hidden" name="test_time" value="12:03 PM"> -->
                                    ...
                                    <form action="{{ route('dtr.logTime', ['type' => 'afternoon_out']) }}" method="POST">
                                        @csrf
                                        <!-- <input type="hidden" name="test_time" value="04:03 PM"> -->
